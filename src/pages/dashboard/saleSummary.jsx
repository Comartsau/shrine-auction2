...
export function SaleSummary() {
  ...
  return (
    <div>
      ...
      <ExcelProduct handleOpen={handleOpenPopupReportProduct} open={open} type={2} />
      ...
      <Card className="mt-5 h-full w-full overflow-scroll">
        <table className="w-full min-w-max table-auto text-left">
          ...
          <tr >
            <td colSpan="4" className="text-right  pr-3 font-bold ">รวมจำนวนเงิน:</td>
            <td className="font-bold">
              {listData.reduce((total, data) => total + Number(data.sale_auction_price),0).toLocaleString()}{" "}  บาท</td>
        </tr>
            </tbody>
          )}
        </table>
